<template>
  <el-form ref="form" :model="form" :rules="rules" style="margin-top: 6px;" size="small" label-width="100px">
    <el-form-item label="发件人邮箱" prop="fromUser">
      <el-input v-model="form.fromUser" style="width: 40%" placeholder="格式为XXX@xx.com" />
    ...
    <el-form-item label="邮箱密码" prop="pass">
      ...
      <span style="color: #C0C0C0;margin-left: 10px;">email Password 密码必须是邮箱开启POP3/SMTP服务的密码</span>
    </el-form-item>
    <el-form-item label="SMTP地址" prop="host">
      <el-input v-model="form.host" style="width: 40%;" placeholder="默认smtp"/>
      <span style="color: #C0C0C0;margin-left: 10px;">SMTP address</span>
    </el-form-item>
    <el-form-item label="SMTP端口" prop="port">
      <el-input v-model="form.port" style="width: 40%;" placeholder="默认465或者25" />
